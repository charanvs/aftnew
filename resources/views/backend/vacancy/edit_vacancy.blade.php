...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Edit Vacancy</div>
					<div class="ps-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="date" name="start_date" class="form-control"  value="{{ $vacancy->start_date }}"   />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="date" name="end_date" class="form-control"  value="{{ $vacancy->end_date }}"   />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <input id="fancy-file-upload" type="file" name="file" value="{{ $vacancy->file }}" accept=".jpg, .png, image/jpeg, image/png" >
                        </div>
                    </div>
                </div>
