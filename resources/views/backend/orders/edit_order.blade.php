            ...
            <form class="row g-3" method="POST" action="{{ route('store.order') }}">
                ...
                <div class="col-md-6">
                    <label for="registration_no" class="form-label">Registration No</label>
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="registration_no" name="registration_no" value="{{ old('registration_no', $order->registration_no) }}" readonly>
                      </div>
                ...
                <div class="col-md-6">
                    <label for="date_of_order" class="form-label">Date of Order</label>
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="date_of_order" name="date_of_order" value="{{ old('date_of_order', $order->date_of_order) }}" readonly>
                      </div>
                      @error('date_of_order')
                          <div class="text-danger">{{ $message }}</div>
                      @enderror
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="applicants" name="applicants" value="{{ old('applicants', $order->applicants) }}">
                      </div>
                      @error('applicants')
                          <div class="text-danger">{{ $message }}</div>
                      @enderror
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="padvocate" name="padvocate" value="{{ old('padvocate', $order->padvocate) }}">
                      </div>
                      @error('padvocate')
                          <div class="text-danger">{{ $message }}</div>
                      @enderror
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="radvocate" name="radvocate" value="{{ old('radvocate', $order->radvocate) }}">
                      </div>
                      @error('radvocate')
                          <div class="text-danger">{{ $message }}</div>
                      @enderror
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="respondent" name="respondent" value="{{ old('respondent', $order->respondent) }}">
                      </div>
                      @error('respondent')
                          <div class="text-danger">{{ $message }}</div>
                      @enderror
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-select" id="court_no" name="court_no">
                            <option value="1" {{ ($order->court_no ?? old('court_no')) == 1 ? 'selected' : '' }}>One</option>
                            <option value="2" {{ ($order->court_no ?? old('court_no')) == 2 ? 'selected' : '' }}>Two</option>
                            <option value="3" {{ ($order->court_no ?? old('court_no')) == 3 ? 'selected' : '' }}>PR Court</option>
                        </select>
                    </div>
                    @error('court_no')
                        <div class="text-danger">{{ $message }}</div>
                ...
                <div class="col-md-6">
                    <label for="sno_cause_list" class="form-label">S.No. of Cause List</label>
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="sno_cause_list" name="sno_cause_list" value="{{ $order->sno_cause_list ?? old('sno_cause_list') }}">
                      </div>
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        ...
                        <button type="button" class="btn btn-success px-4" data-bs-toggle="modal" data-bs-target="#addContentModal">Add Contents</button>
                    </div>
                </div>
            </form>
        </div>
